...
Following are the steps to send logs from a Kubernetes cluster using **Fluent Bit** → **OpenTelemetry Collector (OTEC)** → **Graylog**.
...
> **Note:** For more filters for log deduplication processor, see [logdedup documentation](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/processor/logdedupprocessor#readme).
