...
| `exception.values`                                                               | `stacktrace` or `full_message` | `exception.values` - list of chained exceptions, they should be joined to one line.   | [https://develop.sentry.dev/sdk/telemetry/errors/#exception-interface](https://develop.sentry.dev/sdk/telemetry/errors/#exception-interface) |
